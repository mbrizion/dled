...
import bowl from '../assets/img/creations/bowl/bowl2.jpg'
import senor1 from '../assets/img/creations/senor/senor1.jpg'
import mug from '../assets/img/creations/mug/mug1.jpg'
...
const HomePageV2 = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-2 left-10 w-48 z-10">
      ...
      <div className="absolute top-0 flex flex-col items-center justify-center space-y-8 h-full w-full z-10">
